...
import { SENDING_DATA_CALCULATE_PRICE_BOOKING_REQUEST } from '../constants/action-types'

const postBookingCalculatePriceMiddleware = ({dispatch}) => (next) => (action) => {
    ...
    if(action.type === SENDING_DATA_CALCULATE_PRICE_BOOKING_REQUEST){
...
export default postBookingCalculatePriceMiddleware;